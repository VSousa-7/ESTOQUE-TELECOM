  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="../../index2.html" class="logo"><b>TELECOMUNICAÇÕES</b></a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="../../index.php"><i class="fa fa-circle-o"></i> TELA INICIAL</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href=" ../produtos/add_produto.php"><i class="fa fa-circle-o"></i>CADASTRAR</a></li>
                <li><a href=" ../produtos/add_categoria.php"><i class="fa fa-circle-o"></i>ADICIONAR CATEGORIA</a></li>
                <li><a href=" ../estoque/saida.php"><i class="fa fa-circle-o"></i>SAIDA DOS PRODUTOS</a></li>
                <li><a href=" ../estoque/entrada.php"><i class="fa fa-circle-o"></i>ENTRADA DOS PRODUTOS</a></li>
              </ul>
            </li>
